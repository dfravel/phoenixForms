defmodule PhoenixFormsWeb.UserControllerTest do
  use PhoenixFormsWeb.ConnCase

  alias PhoenixForms.Accounts

  @create_attrs %{address: "some address", date_of_birth: ~N[2010-04-17 14:00:00.000000], email: "some email", first_name: "some first_name", last_name: "some last_name", notifications_enabled: true, number_of_children: 42}
